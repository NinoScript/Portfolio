 ...
 */(function(e, t) {
    ...
    function q(e, t, n) {
        ...
        if (t) {
            s = n ? u[a] : u[a].data;
            if (s) {
                if (!b.isArray(t)) if (t in s) t = [ t ]; else {
                    t = b.camelCase(t);
                    t in s ? t = [ t ] : t = t.split(" ");
                } else t = t.concat(b.map(t, b.camelCase));
    ...
    function rn(e, t) {
        ...
        for (; o < u; o++) {
            ...
            if (t) {
                ...
                r.style.display === "" && nn(r) && (s[o] = b._data(r, "olddisplay", an(r.nodeName)));
            } else if (!s[o]) {
                i = nn(r);
    ...
    function on(e, t, n, r, i) {
        ...
        for (; s < 4; s += 2) {
            ...
            if (r) {
                n === "content" && (o -= b.css(e, "padding" + Zt[s], !0, i));
                n !== "margin" && (o -= b.css(e, "border" + Zt[s] + "Width", !0, i));
            } else {
    ...
    function _n(e) {
        return function(t, n) {
            ...
            if (b.isFunction(n)) while (r = s[i++]) if (r[0] === "+") {
                r = r.slice(1) || "*";
                (e[r] = e[r] || []).unshift(n);
            } else (e[r] = e[r] || []).push(n);
        };
    ...
    b.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            e != null && (P(Object(e)) ? b.merge(n, typeof e == "string" ? [ e ] : e) : p.call(n, e));
            return n;
        },
    ...
    b.ready.promise = function(t) {
        if (!n) {
            n = b.Deferred();
            if (s.readyState === "complete") setTimeout(b.ready); else if (s.addEventListener) {
    ...
    b.Callbacks = function(e) {
        ...
        var n, r, i, s, o, u, a = [], f = !e.once && [], l = function(t) {
            ...
            remove: function() {
                a && b.each(arguments, function(e, t) {
                    var r;
    ...
    b.extend({
        ...
        attr: function(e, n, r) {
            ...
            if (r === t) {
                if (s && o && "get" in s && (u = s.get(e, n)) !== null) return u;
                typeof e.getAttribute !== i && (u = e.getAttribute(n));
                return u == null ? t : u;
            }
            if (r !== null) {
                if (s && o && "set" in s && (u = s.set(e, r, n)) !== t) return u;
                e.setAttribute(n, r + "");
                return r;
            }
            b.removeAttr(e, n);
    ...
    W = {
        ...
        set: function(e, t, n) {
            t === !1 ? b.removeAttr(e, n) : Y && G || !Q.test(n) ? e.setAttribute(!G && b.propFix[n] || n, n) : e[b.camelCase("default-" + n)] = e[n] = !0;
            return n;
        }
    };
    ...
    b.event = {
        ...
        remove: function(e, t, n, r, i) {
            ...
            while (f--) {
                ...
                if (a && !h.length) {
                    (!c.teardown || c.teardown.call(e, d, m.handle) === !1) && b.removeEvent(e, p, m.handle);
                    delete l[p];
                }
            }
    ...
    (function(e, t) {
        ...
        function ht(e, t) {
            ...
            while (u) {
                ...
                for (o in i.filter) if ((r = V[o].exec(u)) && (!f[o] || (r = f[o](r)))) {
                    n = r.shift();
                    s.push({
                        value: n,
                        type: o,
        ...
        ut.attr = function(e, t) {
            ...
            (e.ownerDocument || e) !== c && l(e);
            p || (t = t.toLowerCase());
            return (n = i.attrHandle[t]) ? n(e) : p || S.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t : n && n.specified ? n.value : null;
        };
        ut.error = function(e) {
        ...
        i = ut.selectors = {
            ...
            preFilter: {
                ...
                CHILD: function(e) {
                    ...
                    if (e[1].slice(0, 3) === "nth") {
                        ...
                        e[5] = +(e[7] + e[8] || e[3] === "odd");
                    } else e[3] && ut.error(e[0]);
                    return e;
                },
                PSEUDO: function(e) {
                    var t, n = !e[5] && e[2];
                    if (V.CHILD.test(e[0])) return null;
                    if (e[4]) e[2] = e[4]; else if (n && W.test(n) && (t = ht(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length)) {
                        e[0] = e[0].slice(0, t);
                        e[2] = n.slice(0, t);
                    }
                    return e.slice(0, 3);
            ...
            pseudos: {
                ...
                lang: st(function(e) {
                    ...
                    return function(t) {
                        var n;
                        do if (n = p ? t.getAttribute("xml:lang") || t.getAttribute("lang") : t.lang) {
                            n = n.toLowerCase();
    ...
    b.fn.extend({
        ...
        remove: function(e, t) {
            var n, r = 0;
            for (; (n = this[r]) != null; r++) if (!e || b.filter(e, [ n ]).length > 0) {
        ...
        replaceWith: function(e) {
            var t = b.isFunction(e);
            !t && typeof e != "string" && (e = b(e).not(this).detach());
    ...
    b.extend({
        clone: function(e, t, n) {
            ...
            if (b.support.html5Clone || b.isXMLDoc(e) || !mt.test("<" + e.nodeName + ">")) s = e.cloneNode(!0); else {
    ...
    b.extend({
        ...
        css: function(e, n, r, i) {
            ...
            if (r === "" || r) {
                s = parseFloat(o);
                return r === !0 || b.isNumeric(s) ? s || 0 : o;
            }
            return o;
        },
    ...
    if (e.getComputedStyle) {
        ...
        Rt = function(e, n, r) {
            ...
            if (u) {
                a === "" && !b.contains(e.ownerDocument, e) && (a = b.style(e, n));
    ...
    b.extend({
        ...
        ajax: function(e, n) {
            ...
            if (c.ifModified) {
                b.lastModified[s] && x.setRequestHeader("If-Modified-Since", b.lastModified[s]);
    ...
    b.fn.extend({
        position: function() {
            ...
            if (b.css(r, "position") === "fixed") t = r.getBoundingClientRect(); else {
                e = this.offsetParent();
                t = this.offset();
